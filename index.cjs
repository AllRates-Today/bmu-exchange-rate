'use strict';
// Bank of Mauritius exchange rates via the AllRatesToday API.
const BASE = 'https://allratestoday.com/api/v1/central-bank/bmu';
...
/** Latest rate for one pair, e.g. getRate('USD', 'MUR', { apiKey }). */
